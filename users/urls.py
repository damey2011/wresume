...
from users.forms import EducationForm, CareerForm, SkillForm, WorksForm, OfferForm, BannerMediaForm
...
urlpatterns = [
    ...
    path('education/', views.MultiEntryView.as_view(
        extra_context={'education_tab': True},
    ...
    path('careers/', views.MultiEntryView.as_view(
        extra_context={'careers_tab': True},
